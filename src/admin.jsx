...
const ADMIN_PASSWORD = 'mecontrata2024'; // muda para uma password à tua escolha
...
export default function Admin() {
  ...
  const [aba, setAba] = useState('pendentes'); // 'pendentes' | 'aprovados' | 'denuncias'
                ...
                {perfis.length === 0 ? (
                  <div className="text-center py-16 text-slate-400">
                    ...
                    <p className="font-medium">
                      {aba === 'pendentes' ? 'Nenhum perfil pendente!' : 'Nenhum perfil aprovado ainda.'}
                    </p>
                  </div>
                ) : (
                    ...
                    {perfis.map(p => (
                      <div key={p.id} className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
                        ...
                        <div className="flex gap-2 pt-3 border-t border-slate-100">
                          ...
                          <button
                            onClick={() => verificar(p.id, p.verificado)}
                      ...
                      <div key={d.id} className="bg-white border border-red-100 rounded-2xl p-4 shadow-sm">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <button
                            ...
                            className="text-xs text-slate-300 hover:text-red-400 px-2 py-1 flex-shrink-0"
                          >
                            ✕
                          </button>
                        </div>
